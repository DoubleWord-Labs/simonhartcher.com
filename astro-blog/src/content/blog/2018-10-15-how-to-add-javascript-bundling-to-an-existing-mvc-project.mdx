...
description: "A Modern Approach to Legacy Web Applications"
date: 2018-10-15T00:00:00.000Z
author: "Simon Hartcher"
tags: ["Bundling", "ES6", "ASP.NET", "DotNet", "JavaScript", "Laravel", "MVC", "Webpack"]
cover: "/posts/2018-10-15-how-to-add-javascript-bundling-to-an-existing-mvc-project/cover-small.webp"
preview: "cover-small.webp"
featured: false
draft: false
---
import img_8e0941bb_1b4e_4b4f_a797_aa4d09ef30c3_xlarge from '@assets/2018-10-15-how-to-add-javascript-bundling-to-an-existing-mvc-project/8e0941bb-1b4e-4b4f-a797-aa4d09ef30c3-xlarge.webp';
import img_32e284be_8d2a_4f90_b6d0_d75c198f4fe1_thumbnail from '@assets/2018-10-15-how-to-add-javascript-bundling-to-an-existing-mvc-project/32e284be-8d2a-4f90-b6d0-d75c198f4fe1-thumbnail.webp';
import f60ca765_5214_48b9_9f3b_6b31e4d63a61_medium from '@assets/2018-10-15-how-to-add-javascript-bundling-to-an-existing-mvc-project/f60ca765-5214-48b9-9f3b-6b31e4d63a61-medium.webp';
...
Many modern web applications tend to be very heavily focused on JavaScript. JavaScript is rendering all the HTML, CSS and talking to APIs. However, there are many browsers[1][1] that do not understand keywords like `import` and `require` (the method in which dependencies are referenced in JavaScript). Thus a browser specific solution had to be developed.
...
<Image src={img_8e0941bb_1b4e_4b4f_a797_aa4d09ef30c3_xlarge} alt="Image" />



ASP.NET Core MVC Example Home Page
...
<html>
  ...
  <body>
    ...
    <div class="container body-content">
      @RenderBody()
      <hr />
      <footer><p>&copy; 2018 - mvc</p></footer>
    </div>
    <environment include="Development">
...
```javascript
$('#click-me').click(function (evt) {    alert('Thanks for clicking me');});
```
...
<Image src={img_32e284be_8d2a_4f90_b6d0_d75c198f4fe1_thumbnail} alt="Image" />
...
<Image src={f60ca765_5214_48b9_9f3b_6b31e4d63a61_medium} alt="Image" />
...
1. [All major browsers now support ](https://developers.google.com/web/fundamentals/primers/modules)[`import`](https://developers.google.com/web/fundamentals/primers/modules). I originally implied that no browsers support `import`. Thanks to [Wael Kdouh](https://twitter.com/waelkdouh/status/1052412616675491841) for pointing this out![↩][1]
